...
local function buildPlayer(tab)
    ...
    W.Button(tab, "OPTrainer.Stats.Reset", icon("refresh") .. " Reset Stats", action(function()
        confirmAction("Reset Stats", "[Resets modifiers]", "Resets all stat sliders, multipliers, and health sliders to defaults.", Context.Actions.ResetStats)
    end), "warning")
    W.Tooltip("OPTrainer.Stats.Reset", "Reset all stat and health modifiers to defaults")
