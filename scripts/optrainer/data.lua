...
Data.Enemies = {
    ...
    { name = "Horf", type = 12, variant = 0 },
    { name = "Mulligan", type = 16, variant = 0 },
    { name = "Globin", type = 24, variant = 0 },
    { name = "Clotty", type = 15, variant = 0 },
    { name = "Keeper", type = 86, variant = 0 },
    { name = "Fly", type = 13, variant = 0 },
    { name = "Pooter", type = 14, variant = 0 },
    { name = "Leaper", type = 34, variant = 0 },
    { name = "Host", type = 27, variant = 0 },
    { name = "Charger", type = 23, variant = 0 },
    { name = "Maggot", type = 21, variant = 0 },
    { name = "Spider", type = 85, variant = 0 },
    { name = "Boom Fly", type = 25, variant = 0 },
    { name = "Dople", type = 53, variant = 0 },
    -- Bosses / Mini-bosses
    { name = "Monstro", type = 20, variant = 0 },
    { name = "Larry Jr.", type = 19, variant = 0 },
    { name = "Duke of Flies", type = 67, variant = 0 },
    { name = "The Haunt", type = 260, variant = 0 },
    { name = "Dingle", type = 261, variant = 0 },
    { name = "Peep", type = 68, variant = 0 },
    { name = "Loki", type = 69, variant = 0 },
    { name = "Gurdy", type = 36, variant = 0 },
    { name = "Chub", type = 28, variant = 0 },
    { name = "Mom", type = 45, variant = 0 },
    { name = "Famine", type = 63, variant = 0 },
    { name = "Pestilence", type = 64, variant = 0 },
    { name = "War", type = 65, variant = 0 },
    { name = "Death", type = 66, variant = 0 },
    { name = "Satan", type = 84, variant = 0 },
    { name = "Mega Satan", type = 274, variant = 0 },
    { name = "The Lamb", type = 273, variant = 0 },
    { name = "Uriel", type = 271, variant = 0 },
    { name = "Gabriel", type = 272, variant = 0 },
    { name = "Stain", type = 401, variant = 0 },
    { name = "Brownie", type = 402, variant = 0 },
    { name = "Forsaken", type = 403, variant = 0 },
    { name = "Little Horn", type = 404, variant = 0 },
    { name = "Ultra Greed", type = 406, variant = 0 },
    { name = "Hush", type = 407, variant = 0 },
    { name = "Delirium", type = 412, variant = 0 },
    { name = "Siren", type = 904, variant = 0 },
    { name = "Heretic", type = 905, variant = 0 },
    { name = "Mother", type = 912, variant = 0 },
    { name = "Dogma", type = 950, variant = 0 },
    { name = "Beast", type = 951, variant = 0 },
}
